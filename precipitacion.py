#fecha - temp minima -  temp maxima - precipitacion  - cant dias mayor nublado - cant dias parc nublados - cant dias soleados
...
def clima(datos):
    ...
    matriz=np.array(listadelistas).reshape(len(lista1),7)
